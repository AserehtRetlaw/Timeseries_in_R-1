...
# comp_fill <- function(value , comp_with, comp_n){
# 	for (i in 0:comp_n) {
# 		case_when(lag(comp_with, n = i) == value ~ 1,
# 			  lead(comp_with, n = i) == value ~ 1,
# 			  TRUE ~ 0)
# 	}
# }
```
...
# df %>%
# mutate(qc_tot = qc1 + qc2 + qc3) %>%
# mutate(flag_num =
# if_else(qc_tot > 1, 1, 0)) %>%
# mutate(flag_txt =
# if_else(qc_tot > 1, "bad", "good"))
```
