...
## Regressions
```{r regressions}
hobo_airport <- lm(refs$my_hobo ~ refs$dwd_airport)

hobo_urban <- lm(refs$my_hobo ~ refs$dwd_urban)

hobo_uni <- lm(refs$my_hobo ~ refs$uni_meteo)

hobo_wbi <- lm(refs$my_hobo ~ refs$wbi)
